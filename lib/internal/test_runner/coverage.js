...
class TestCoverage {
  constructor(coverageDirectory,
    ...
    this.excludeFiles = ArrayPrototypeMap(excludeFiles || [], (file) => resolve(workingDirectory, file));
  ...
  shouldSkipFileCoverage(url) {
    ...
    return StringPrototypeIncludes(url, '/node_modules/') || ArrayPrototypeIncludes(this.excludeFiles, absolutePath);
  }
}
